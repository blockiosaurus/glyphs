...
2. Next, install this library using the package manager of your choice.
   ```sh
   npm install @metaplex-foundation/bgl-glyphs
   ```
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { bglGlyphs } from '@metaplex-foundation/bgl-glyphs';
   umi.use(bglGlyphs());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://bgl-glyphs-js-docs.vercel.app).
